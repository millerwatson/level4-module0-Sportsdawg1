...
public class GridPanel extends JPanel{
	...
	public void clickPixel(int mouseX, int mouseY) {
		...
		int distanceOffX = mouseX % pixelWidth;
		int distanceOffY = mouseY % pixelHeight;
		int arrayPosX = (mouseX - distanceOffX) / pixelWidth;
		int arrayPosY = (mouseY - distanceOffY) / pixelHeight;
		pixels[arrayPosX][arrayPosY].color = color;
	}
