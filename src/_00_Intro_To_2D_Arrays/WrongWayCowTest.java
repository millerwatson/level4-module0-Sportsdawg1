...
public class WrongWayCowTest {
    ...
    public void simple() {
      ...
      assertArrayEquals(new int[]{3,0}, WrongWayCow.findWrongWayCow(show(field)));
    }
    ...
    public void ex1() {
      ...
      assertArrayEquals(new int[]{6,2}, WrongWayCow.findWrongWayCow(show(field)));
    }
    ...
    public void ex2() {
      ...
      assertArrayEquals(new int[]{8,4}, WrongWayCow.findWrongWayCow(show(field)));
    }
    ...
    public void aFieldFullOfJunk() {
      ...
      assertArrayEquals(new int[]{29,0}, WrongWayCow.findWrongWayCow(show(field)));
    }
    ...
    public void wwcW() {
      ...
      assertArrayEquals(new int[]{9,5}, WrongWayCow.findWrongWayCow(show(field)));
    }
  ...
  public void wwcE() {
    ...
    assertArrayEquals(new int[]{27,15}, WrongWayCow.findWrongWayCow(show(field)));
  }
  ...
  public void wwcN() {
    ...
    assertArrayEquals(new int[]{14,8}, WrongWayCow.findWrongWayCow(show(field)));
  }
  ...
  public void wwcS() {
    ...
    assertArrayEquals(new int[]{3,4}, WrongWayCow.findWrongWayCow(show(field)));
  }
  ...
  public void mostlyEmpty() {
    ...
    assertArrayEquals(new int[]{0,0}, WrongWayCow.findWrongWayCow(show(field)));
  }
